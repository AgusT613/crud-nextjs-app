...
export default function Todo({ todo }: { todo: ITodo }) {
  return (
    <div className="border border-foreground p-4 max-w-80 min-w-60 flex flex-col rounded-lg">
      ...
      {todo.description && (
        <textarea
          ...
          className="resize-none field-sizing-content text-sm opacity-80 w-full mt-4"
        />
      )}
    </div>
  );
